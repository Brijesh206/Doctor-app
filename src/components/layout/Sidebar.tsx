...
import {
  FaTachometerAlt, FaUserInjured, FaUserMd, FaPills, FaNotesMedical,
  FaCalendarCheck, FaChartBar, FaCog, FaHospital, FaBars, FaTimes, FaSignOutAlt,
} from 'react-icons/fa';
      ...
      <div className={clsx(
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="text-sm font-bold text-gray-900 leading-tight">MediAdmin</p>
      ...
      <div className="px-2 pb-4 space-y-1 border-t border-gray-100 pt-3">
        {!collapsed && user && (
          <div className="px-3 py-2 rounded-xl bg-primary-50 mb-2">
            <p className="text-xs font-semibold text-primary-800 truncate">{user.name}</p>
    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          <div className="absolute inset-0 bg-gray-900/50 backdrop-blur-sm" onClick={onMobileClose} />
