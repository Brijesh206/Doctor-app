...
const features = [
	{
		...
		description:
			"Maintain complete patient profiles, medical history, visit records, and health metrics in one place.",
	...
	},
	{
		...
		description:
			"Manage doctor availability, specializations, consultation fees, and daily appointment schedules.",
		color:
	...
	},
	{
		...
		description:
			"Track medicine stock levels, expiry dates, and receive low-stock alerts automatically.",
		color:
	...
	},
	{
		...
		description:
			"Create, manage, and track digital prescriptions linked to patients and doctors seamlessly.",
	...
	},
	{
		...
		description:
			"Online appointment booking with real-time slot availability, reminders, and status tracking.",
		color:
	...
	},
	{
		...
		description:
			"Powerful dashboards with trend charts, KPIs, and exportable CSV reports for data-driven decisions.",
	...
	},
	{
		...
		description:
			"Enterprise-grade security with end-to-end encryption, audit logs, and full HIPAA compliance.",
		color:
	...
	},
	{
		...
		description:
			"Automated alerts for appointments, medicine expiry, low stock, and critical system events.",
		color:
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="text-center max-w-2xl mx-auto mb-16">
					...
					<p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed">
						MediAdmin brings together all the tools a modern hospital needs to
