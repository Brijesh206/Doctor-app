...
import { FaEnvelope, FaLock, FaArrowRight, FaHospital, FaUserMd, FaUserInjured, FaPills } from 'react-icons/fa';
import { useAuth } from '../../context/AuthContext';
import toast from 'react-hot-toast';

const schema = yup.object({ email: yup.string().email('Invalid email').required('Email required'), password: yup.string().min(6, 'Min 6 characters').required('Password required') });
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 flex-col p-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
            <defs><pattern id="login-grid" width="60" height="60" patternUnits="userSpaceOnUse">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center">
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">
            Modern Healthcare<br />Administration
          </h2>
          <p className="text-lg text-white/80 mb-10">
            Streamline your hospital operations with our comprehensive management suite built for healthcare professionals.
          </p>
        ...
        <p className="relative z-10 text-white/40 text-xs">© 2025 MediAdmin. Secure & HIPAA Compliant.</p>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-card border border-gray-100 p-8">
            <div className="mb-8">
              ...
              <p className="text-sm text-gray-500">Sign in to your admin account to continue</p>
            </div>

            {/* Demo hint */}
            <div className="mb-6 p-3 bg-sky-50 border border-sky-200 rounded-xl">
              <p className="text-xs text-sky-700">
                <span className="font-semibold">Demo:</span> Use any email & password (min 6 chars) to login
              </p>
            </div>
